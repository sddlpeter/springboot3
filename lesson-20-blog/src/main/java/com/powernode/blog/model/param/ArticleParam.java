package com.powernode.blog.model.param;
...
public class ArticleParam {
    ...
    @NotNull(message = "修改时必须由id", groups = {EditArticle.class})
    ...
    @Size(min = 2,max = 30, message = "文章副标题在{min}-{max}", groups = {AddArticle.class, EditArticle.class})
    private String summary;

    @NotBlank(message = "请输入文章内容", groups = {AddArticle.class, EditArticle.class})
    @Size(min = 20,max = 8000, message = "文章内容在{min}-{max}", groups = {AddArticle.class, EditArticle.class})
